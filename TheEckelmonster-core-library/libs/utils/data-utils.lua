...
local function get_runtime_global_setting(data)

    if (not data or type(data) ~= "table") then return end
    if (not data.setting or type(data.setting) ~= "string") then return end

    local setting =     type(Runtime_Global_Settings_Constants) == "table"
                    and type(Runtime_Global_Settings_Constants.settings_dictionary) == "table"
                    and type(Runtime_Global_Settings_Constants.settings_dictionary[data.setting]) == "table"
                    and Runtime_Global_Settings_Constants.settings_dictionary[data.setting].default_value ~= nil
                    and Runtime_Global_Settings_Constants.settings_dictionary[data.setting].default_value
                    or
                        data.default_value
...
-- local function get_runtime_user_setting(data)
...
local function get_startup_setting(data)

    if (not data or type(data) ~= "table") then return end
    if (not data.setting or type(data.setting) ~= "string") then return end

    local setting =     type(Startup_Settings_Constants) == "table"
                    and type(Startup_Settings_Constants.settings_dictionary) == "table"
                    and type(Startup_Settings_Constants.settings_dictionary[data.setting]) == "table"
                    and Startup_Settings_Constants.settings_dictionary[data.setting].default_value ~= nil
                    and Startup_Settings_Constants.settings_dictionary[data.setting].default_value
                    or
                        data.default_value
...
function data_utils.get_runtime_global_setting(data)
...
function data_utils.get_startup_setting(data)
...
function data_utils.create_custom_tooltip_quality_effects_atomic(params)
